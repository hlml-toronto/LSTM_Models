...
datafile0 = 'poems.txt'
datafile = 'poems.data'
shelvefile = 'poems.metadata.shelve'
modelfile = 'poems.model.h5'


#######################################################################

# If datafile hasn't been made yet, make it
if (not os.path.isfile('data/' + datafile0)):
    ddb.create_txtfile_dbpoetry( datafile0 )
...
if (not os.path.isfile('data/' + shelvefile)):
    ...
    # limitations.
    corpus1 = corpus0.split(' ')[0:5s0000]
